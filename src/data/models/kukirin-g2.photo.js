...
export default {
  ...
  pieces: [
    ...
    { id: 'stem', name: 'Kormányoszlop', group: 'front', size: 'medium', labelAngle: -100, patternTransform: 'skewX(-10)', priceGroup: 'stem',
    ...
    { id: 'joint', name: 'Csuklóborítás (hajtás)', group: 'front', size: 'small', priceGroup: 'joint',
      d: 'M 775 499 L 778 510 L 779 535 L 772 550 L 772 566 L 775 565 L 778 555 L 783 556 L 785 566 L 842 566 L 842 550 L 835 532 L 827 499 Z M 832 545 L 836 545 L 838 547 L 842 559 L 841 566 L 833 565 L 831 563 L 830 550 Z' },
    { id: 'neck', name: 'Dekk-nyak / első lengőkar-borítás', group: 'deck', size: 'medium', patternTransform: 'skewX(-28)', priceGroup: 'neck',
      d: 'M 846 561 L 842 560 L 842 565 L 837 566 L 833 565 L 831 560 L 783 560 L 785 571 L 778 576 L 774 576 L 773 569 L 776 560 L 768 560 L 764 573 L 764 589 L 761 593 L 761 597 L 698 671 L 698 705 L 709 705 L 752 653 L 757 654 L 756 660 L 720 705 L 772 705 L 778 698 L 778 696 L 774 693 L 774 689 L 781 680 L 786 681 L 784 704 L 788 705 L 788 688 L 795 674 L 815 656 L 821 656 L 822 658 L 832 657 L 832 650 L 834 648 L 851 642 L 849 622 L 852 609 L 852 592 Z M 794 620 L 793 625 L 783 629 L 778 628 L 778 624 L 780 622 L 789 619 Z' },
    ...
    { id: 'front-swingarm', name: 'Első lengőkar-borítás', group: 'front', size: 'small', patternTransform: 'skewY(20)', priceGroup: 'fork',
